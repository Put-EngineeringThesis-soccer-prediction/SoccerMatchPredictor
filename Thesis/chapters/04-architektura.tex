...
\begin{figure}[H]%
    \centering
    \subfloat[\centering Wynik wraz z prawdopodobieństwem]{{\includegraphics[width=6cm,height=5cm]{figures/Interactive_results.png} }}%
    \qquad
    \subfloat[\centering Brak wyniku dominującego]{{\includegraphics[width=8cm,height=5cm]{figures/Interactive_results2.png} }}%
